...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-center rounded-2xl overflow-hidden bg-muted text-muted-foreground",
      className
    )}
    {...props}
  />
